...
/*
**************NOTE** This is a Script for just the dummy hand, is not optimized to work with the VR and should only be used for setting up pickup script settings*********************
...
**Places to set prefferencial bounds and setting adjustments (ctr+F these terms)
	...
	**Console logs usefull when setting up, but can be commented out after(ctr+F (SetUpLogs))**
	**Public variables and functions useed for eas of setting up objecs, comment out after setup for optimization (ctr+F (SetUpHelpers))
...
public class DummyHandController : MonoBehaviour {
	...
	public DummyHandController otherHand;
